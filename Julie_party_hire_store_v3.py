...
def print_hire_details():
    ...
    while name_count < 1 :
        ...
        Label(main_window, text=entry_customer.get()).grid(column=1, row=name_count+6)
        Label(main_window, text=entry_receipt_number.get()).grid(column=2, row=name_count+6)
        Label(main_window, text=entry_item.get()).grid(column=3, row=name_count+6)
        Label(main_window, text=entry_number_hired.get()).grid(column=4, row=name_count+6)
        name_count += 1
