...
def print_hire_details():
    ...
    global name_count, j_names, total_entries
    name_count=0
...
def delete_row():
    global hire_details, total_entries, delete_item
...
def setup_buttons():
    global entry_customer, entry_receipt_number, entry_item, entry_number_hired, total_entries, delete_item
    ...
    Button(main_window, text="Delete Row", command=delete_row).grid(column=4, row=2)
    ...
    delete_item.grid(column=3, row=2, padx=10, pady=5)
